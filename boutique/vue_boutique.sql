...
SELECT v.idVetement, v.vetementName, v.prix, v.vetDescription, v.photo, c.libelle AS categorie_libelle, s.libelle AS sexe_libelle, m.libelle AS mention_libelle
FROM vetement v
